...
export default function ItemDetailsPanel({
  ...
  return (
    <div className="space-y-6 mt-20 mx-auto">
      {editMode ? (
        <>
          <input
            type="text"
          ...
          <Button onClick={saveChanges} color="black" className="px-[36px] py-3">
        ...
        <>
          ...
          <button
            ...
            className="px-[55px] py-4 bg-black text-white rounded hover:bg-black"
          >
      ...
      <div className="flex flex-col gap-5 my-5">
        <Button
          ...
          className="flex items-center gap-3 py-4 bg-pink-400 justify-center"
        >
