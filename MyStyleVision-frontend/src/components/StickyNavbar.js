...
import img from "../myntra-removebg.png";
import {
  Navbar,
  Typography,
  Button,
    ...
    <div className="-m-6 max-h-screen overflow-scroll">
      <Navbar className="sticky top-3 z-10 h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4">
        <div className="flex items-center lg:mt-4 mt-2 justify-between">
          ...
          >
            <Link to="/" className="flex flex-row gap-x-1 items-center hover:text-brand-dark">
            <div>
              <img src={img} className="w-[80px] h-[56px]"/>
            </div>
              <span>MyStyleVision</span>
            </Link>
          </Typography>
          <div className="flex items-center gap-4 mr-12">
            ...
            <div className="flex items-center gap-x-1">
              ...
              <Link to='/admin'>
              <Button className="px-9 bg-pink-400 py-4">
                Create Collection
              </Button>
              </Link>
            </div>
